...
def upload_embeddings_to_qdrant(qdrant_client, points, collection_name="vectors"):
...
def process_file(filepath, qdrant_client, collection_name="vectors"):
    ...
    if points:
        ...
        upload_embeddings_to_qdrant(qdrant_client, points, collection_name)
...
def process_files_in_folder(folder_path, collection_name="vectors"):
    ...
    with concurrent.futures.ThreadPoolExecutor() as executor:
        futures = [executor.submit(process_file, filepath, qdrant_client, collection_name) for filepath in filepaths]
